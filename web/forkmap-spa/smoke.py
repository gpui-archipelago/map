...
def main() -> int:
    ...
    try:
        ...
        checks = [
            ...
            ("nav chrome (the suite breadcrumb, the tabs, the counts, the repo link)",
             "#/", ["gpui-archipelago", "Fork Map", "Overview", "Changes", "Alignment", "Configure", "Journal",
                     "href=\"https://gpui-archipelago.github.io/\"",
                     "href=\"https://github.com/gpui-archipelago/map\"", "GitHub"],
             ["(the fork map)", "Map overview", "header-schema"]),
            ...
            ("documents index (hidden #/docs: every published doc, one row each)",
             "#/docs", ["id=\"view-docs\"", "id=\"docs-list\"", "id=\"docs-row-11\"",
                        "docs/04-user-docs/11-alias-shim-for-kits.md"], []),
            ("documents index deep link (#/docs?doc=07 opens the reader on that doc)",
             "#/docs?doc=07", ["data-doc-status=\"ready\"", "id=\"study-modal\"", "data-doc=\"7\"", "id=\"docs-list\""], []),
            ("documents index unknown doc param (#/docs?doc=99 opens nothing)",
             "#/docs?doc=99", ["id=\"view-docs\"", "id=\"docs-list\""], ["id=\"study-modal\""]),
            ("unknown route falls back to the landing (never an empty main)",
             "#/not-a-route", ["The GPUI fork map", "id=\"fork-table\""], []),
